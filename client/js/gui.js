...
function createHangmanCanvas(element, maxLives, size=null){
    container = element;
    container.innerHTML = "";
    let display = container.appendChild(document.createElement("canvas"));
...
export {createHangmanCanvas, setHangmanCanvas, setMaxLives};